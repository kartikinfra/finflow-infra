...
app.get('/report', (req, res) => {
  ...
  doc.font('Helvetica-Bold').text('Entity:', 310, 115).font('Helvetica').text('[PA Entity Name]', 420, 115);
  doc.font('Helvetica-Bold').text('RBI Reg No:', 310, 130).font('Helvetica').text('[RBI-PA-XXXX]', 420, 130);
  ...
  doc.fillColor('#9CA3AF').fontSize(7).font('Helvetica')
     .text(`Auto-generated: ${now.toISOString().slice(0,19)} UTC | Falco 0.43.1 (eBPF) + FalcoSidekick + falco-receiver | kartikinfra.in`, 
